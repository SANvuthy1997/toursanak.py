...
class Post(db.Model):
    ...
    cost = db.Column(db.String(200),nullable=True)
    
    def __init__(self, title, description,category_id, feature_image, user_id,views=0,images='',price=0,date='',participants='',cost=''):
        self.title = title
        self.slug =slugify(title)
        self.description = description
        self.feature_image = feature_image
